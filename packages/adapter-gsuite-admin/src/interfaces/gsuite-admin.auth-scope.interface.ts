...
type ScopesForUserSecurityFeatures = 'https://www.googleapis.com/auth/admin.directory.user.security';
...
type ScopesForNotificaitons = 'https://www.googleapis.com/auth/admin.directory.notifications';
